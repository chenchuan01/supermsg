	...
	<body>
		<div  id="themeSetting_wrap" style="display:none;">			
				...
				<div id="themeSetting_body" class="themeSetting_body">	
					...
					<a href="javascript:;" themeid="theme_blue" class="themeSetting_settingButton" id="themeSetting_theme_blue">
					...
					<a href="javascript:;" themeid="theme_pinky_night" class="themeSetting_settingButton" id="themeSetting_theme_pinky_night">
					...
					<a href="javascript:;" themeid="theme_green" class="themeSetting_settingButton" id="themeSetting_theme_green">
					...
					<a href="javascript:;" themeid="theme_wood1" class="themeSetting_settingButton" id="themeSetting_theme_wood1">
					...
					<a href="javascript:;" themeid="theme_wood2" class="themeSetting_settingButton" id="themeSetting_theme_wood2">
					...
					<a href="javascript:;" themeid="theme_universe" class="themeSetting_settingButton" id="themeSetting_theme_universe">
					...
					<a href="javascript:;" themeid="theme_metal" class="themeSetting_settingButton" id="themeSetting_theme_metal">
					...
					<a href="javascript:;" themeid="theme_pinky_light" class="themeSetting_settingButton" id="themeSetting_theme_pinky_light">
					...
					<a href="javascript:;" themeid="theme_pinky_flower" class="themeSetting_settingButton" id="themeSetting_theme_pinky_flower">
					...
					<a href="javascript:;" themeid="theme_christmas" class="themeSetting_settingButton" id="themeSetting_theme_christmas">
					...
					<a href="javascript:;" themeid="theme_2011" class="themeSetting_settingButton" id="themeSetting_theme_2011">
					...
					<a href="javascript:;" themeid="theme_blue1" class="themeSetting_settingButton" id="themeSetting_theme_blue1">
					...
					<a href="javascript:;" themeid="theme_spring_festival" class="themeSetting_settingButton" id="themeSetting_theme_spring_festival">
					...
					<a href="javascript:;" themeid="theme_blue_glow" class="themeSetting_settingButton themeSetting_selected" id="themeSetting_theme_blue_glow">
					...
					<a href="javascript:;" themeid="theme_green_glow" class="themeSetting_settingButton" id="themeSetting_theme_green_glow">
					...
					<a href="javascript:;" themeid="theme_orange_glow" class="themeSetting_settingButton" id="themeSetting_theme_orange_glow">
					...
					<a href="javascript:;" themeid="theme_valentinesDay" class="themeSetting_settingButton" id="themeSetting_theme_valentinesDay">
					...
					<a href="javascript:;" themeid="theme_cloud" class="themeSetting_settingButton" id="themeSetting_theme_cloud">
					...
					<a href="javascript:;" themeid="theme_gravity" class="themeSetting_settingButton" id="themeSetting_theme_gravity">
					...
					<a href="javascript:;" themeid="theme_7_7" class="themeSetting_settingButton" id="themeSetting_theme_7_7">
					...
					<a href="javascript:;" themeid="theme_teachersDay" class="themeSetting_settingButton" id="themeSetting_theme_teachersDay">
					...
					<a href="javascript:;" themeid="theme_midAutumn" class="themeSetting_settingButton" id="themeSetting_theme_midAutumn">
					...
					<a href="javascript:;" themeid="theme_lookUpSky" class="themeSetting_settingButton" id="themeSetting_theme_lookUpSky">
					...
					<a href="javascript:;" themeid="theme_grass" class="themeSetting_settingButton" id="themeSetting_theme_grass">
					...
					<a href="javascript:;" themeid="theme_childhood" class="themeSetting_settingButton" id="themeSetting_theme_childhood">
					...
					<a href="javascript:;" themeid="theme_skyBlue" class="themeSetting_settingButton" id="themeSetting_theme_skyBlue">
					...
					<a href="javascript:;" themeid="theme_dandelionDream" class="themeSetting_settingButton" id="themeSetting_theme_dandelionDream">
					...
					<a href="javascript:;" themeid="theme_paintingTime" class="themeSetting_settingButton" id="themeSetting_theme_paintingTime">
					...
					<a href="javascript:;" themeid="theme_dreamSky" class="themeSetting_settingButton" id="themeSetting_theme_dreamSky">
		...
		<div class="taskbar_start_menu_container" id="startMenuContainer" _olddisplay="block" style="display: none;">  
			...
			<ul class="taskbar_start_menu">
				...
				<li cmd="download">
					...
					<a href="javascript:;">关于Q+ Web</a>
				</li>
				<li cmd="helper">
					<a title="新手指导" href="javascript:;">新手指导</a>
				</li></ul>    
				<a class="startMenuImg logout_botton" title="注销当前用户" cmd="logout" href="javascript:;"></a>
				</div>
		</div>
